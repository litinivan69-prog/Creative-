...
const defaultConfiguration = { vkPosts: 1, telegramPosts: 1, okPosts: 0, dzenArticles: 1, vcruArticles: 0, carousels: 0, carouselSlides: 4, carouselPlatform: "vk" as const, quickAnnouncements: 0, reviewReplies: 0, dzenArticleTopic: "", vcruArticleTopic: "" };
