  ...
  return (
    <form action={saveSelfServiceContentOrder} className="grid gap-5 lg:grid-cols-[1fr_330px]">
      <section className="space-y-3">
        ...
        {error === "credits" ? <p className="rounded-2xl border border-amber-300/15 bg-amber-300/[0.06] px-4 py-3 text-xs text-amber-100/80">На балансе не хватает кредитов. Уменьшите набор или выберите тариф.</p> : null}
