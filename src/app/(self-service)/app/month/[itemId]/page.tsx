  ...
  return (
    ...
    >
      <div>
        ...
        {query.notice === "visual_revised" ? <div className="mb-5 rounded-2xl border border-violet-400/15 bg-violet-500/10 px-4 py-3 text-xs font-semibold text-violet-100">Новый вариант визуала готов. Предыдущий вариант сохранён в истории.</div> : null}
