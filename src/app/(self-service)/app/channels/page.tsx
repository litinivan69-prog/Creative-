...
export default async function SelfServiceChannelsPage({ searchParams }: { searchParams: Promise<{ notice?: string; error?: string; from?: string }> }) {
  ...
  const socialDefinitions = [
    ...
    { platform: "vk" as const, label: "VK", description: "Публикация полного текста и изображений в сообщество.", referencePlaceholder: "https://vk.com/сообщество", tokenPlaceholder: "Вставьте ключ сообщества", platformToken: platformVkToken, platformHint: platformVkLabel, oauthAvailable: isVkOauthConfigured() },
