...
export const SelfServiceOnboardingSchema = z.object({
  ...
  brief: z.object({
    ...
    logoMode: z.enum(["upload", "url", "none"]).optional().default("none"),
...
export function onboardingRawBrief(input: SelfServiceOnboarding) {
  ...
  return [
    ...
    brief.logoMode === "none" ? "Логотип: не использовать" : brief.logoUrl ? `Логотип: ${brief.logoUrl}` : "",
