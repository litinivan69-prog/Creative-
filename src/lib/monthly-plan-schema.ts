...
export const PlannedContentItemSchema = z.object({
  ...
  week: nonEmptyText.optional(),
  campaignTheme: nonEmptyText.optional(),
  contentPillar: nonEmptyText.optional(),
  channelRole: nonEmptyText.optional(),
  sequenceReason: nonEmptyText.optional(),
