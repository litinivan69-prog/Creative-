...
export const ClientPresenceBlueprintSchema = z.object({
  ...
  missingBriefFields: z.array(nonEmptyText),
  ...
  notRecommendedPlatforms: z.array(NotRecommendedPlatformSchema),
  ...
  integrationRequirements: z.array(IntegrationRequirementSchema),
